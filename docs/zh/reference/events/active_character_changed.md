[givm](../../reference.md) / [事件](../events.md) / **active_character_changed**
...
一名玩家的出战角色已经设置的通知。响应者可以通过新的出战角色找到对应玩家。
...
| | |
| --- | --- |
| [`set_active_character`](../instructions/set_active_character.md) | 设置出战角色 |
