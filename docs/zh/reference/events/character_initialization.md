[givm](../../reference.md) / [事件](../events.md) / **character_initialization**
...
角色的初始状态正在准备。角色定义通过它提供最大生命、初始生命、充能上限等开局状态。
...
| | |
| --- | --- |
| [`enter_character`](../instructions/enter_character.md) | 使角色入场 |
| [`initialize_characters`](../instructions/initialize_characters.md) | 初始化已有角色 |
