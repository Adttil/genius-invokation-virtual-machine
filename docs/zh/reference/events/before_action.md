[givm](../../reference.md) / [事件](../events.md) / **before_action**
...
struct observer_source
{
    ...
    static givm::program_entry<givm::before_action> handle(
        ...
        givm::before_action&, const givm::card_table&, givm::random_fn&)
    {
        ++*definition.count;
...
int main()
{
    ...
    view.definition().handle<givm::before_action>(view, event, table, random);
