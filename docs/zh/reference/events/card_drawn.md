[givm](../../reference.md) / [事件](../events.md) / **card_drawn**
...
一张牌已经从牌堆进入手牌的通知。响应者可以通过牌的标识读取抽到的牌。
...
| | |
| --- | --- |
| [`draw_cards`](../instructions/draw_cards.md) | 抽取手牌 |
| [`replace_cards`](../instructions/replace_cards.md) | 替换手牌 |
