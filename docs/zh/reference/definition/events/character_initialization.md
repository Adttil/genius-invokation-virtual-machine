[givm](../../../reference.md) / [定义](../../definition.md) / [事件](../events.md) / **character_initialization**
...
[`enter_character`](../commands/enter_character.md) 和 [`initialize_characters`](../commands/initialize_characters.md) 要求在此次 `handle` 中直接填写 `state`；它们不执行该响应返回的程序入口。
