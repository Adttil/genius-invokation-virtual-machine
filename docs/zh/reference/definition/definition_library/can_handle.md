[givm](../../../reference.md) / [定义](../../definition.md) / [definition_library](../definition_library.md) / **can_handle**
...
|  |  |
| --- | --- |
| `TEvent` | 要查询的事件，须属于该 view 的 [`subscribed_events`](../subscribed_events.md) |
| `TView` | 响应实体的只读 view，须属于定义对应的 [`views_of_definition`](../views_of_definition.md) |
