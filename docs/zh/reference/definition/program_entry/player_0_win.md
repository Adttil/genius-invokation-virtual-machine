[givm](../../../reference.md) / [定义](../../definition.md) / [program_entry](../program_entry.md) / **player_0_win**

# givm::program_entry::player_0_win
...
取得使对局以玩家 0 获胜结束的入口。取得入口本身不会结束对局，进入该入口后才产生终局结果。
