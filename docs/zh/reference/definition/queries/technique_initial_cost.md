[givm](../../../reference.md) / [定义](../../definition.md) / [查询](../queries.md) / **technique_initial_cost**

# givm::technique_initial_cost
...
取得特技自身的骰子、充能费用与行动速度。使用特技费用预览以此为基础，再通过 [`cost_of_technique`](../events/cost_of_technique.md) 响应处理本场对局中的增减费与速度调整。
