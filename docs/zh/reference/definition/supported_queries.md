...
| `attachment_view` | [`attachment_state_limit`](queries/attachment_state_limit.md)、[`technique_initial_cost`](queries/technique_initial_cost.md)、[`technique_target_validation`](queries/technique_target_validation.md) |
| 其他定义类别 | 空列表。 |
