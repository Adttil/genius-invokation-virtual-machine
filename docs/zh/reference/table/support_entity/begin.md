[givm](../../../reference.md) / [牌桌](../../table.md) / [support_entity](../support_entity.md) / **begin**

# givm::support_entity::begin
...
指向该 [`support_entity`](../support_entity.md) 访问对象自身的只读指针。若实体无效，它等于 `end()`。
