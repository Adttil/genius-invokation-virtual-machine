[givm](../../../reference.md) / [牌桌](../../table.md) / [hand_card_entity](../hand_card_entity.md) / **begin**

# givm::hand_card_entity::begin
...
指向该 [`hand_card_entity`](../hand_card_entity.md) 访问对象自身的只读指针。若实体无效，它等于 `end()`。
