[givm](../../../reference.md) / [牌桌](../../table.md) / [hand_card_entity](../hand_card_entity.md) / **add**

# givm::hand_card_entity::add
...
新增加的 [`hand_card_status_entity`](../hand_card_status_entity.md)。
