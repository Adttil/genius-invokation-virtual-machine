[givm](../../../reference.md) / [牌桌](../../table.md) / [deck_card_status_entity](../deck_card_status_entity.md) / **begin**

# givm::deck_card_status_entity::begin
...
指向该 [`deck_card_status_entity`](../deck_card_status_entity.md) 访问对象自身的只读指针。若实体无效，它等于 `end()`。
