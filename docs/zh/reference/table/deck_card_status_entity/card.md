[givm](../../../reference.md) / [牌桌](../../table.md) / [deck_card_status_entity](../deck_card_status_entity.md) / **card**

# givm::deck_card_status_entity::card
...
具有相同读写权限的 [`deck_card_entity`](../deck_card_entity.md)。
