[givm](../../../reference.md) / [牌桌](../../table.md) / [deck_card_status_entity](../deck_card_status_entity.md) / **is_mutable**

# givm::deck_card_status_entity::is_mutable
...
该访问对象是否允许修改牌库卡牌上的状态。可写实体为 `true`，只读视图为 `false`。
