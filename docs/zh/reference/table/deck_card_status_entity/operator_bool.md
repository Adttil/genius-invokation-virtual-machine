[givm](../../../reference.md) / [牌桌](../../table.md) / [deck_card_status_entity](../deck_card_status_entity.md) / **operator bool**

# givm::deck_card_status_entity::operator bool
...
int main()
{
    ...
    std::println("移除前有效: {}", static_cast<bool>(entity));
    entity.erase();
    std::println("移除后有效: {}", static_cast<bool>(entity));
}
```
