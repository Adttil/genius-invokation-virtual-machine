[givm](../../../reference.md) / [牌桌](../../table.md) / [deck_card_entity](../deck_card_entity.md) / **statuses**

# givm::deck_card_entity::statuses
...
产生 [`deck_card_status_entity`](../deck_card_status_entity.md) 的 [`card_status_range`](../card_status_range.md)。
