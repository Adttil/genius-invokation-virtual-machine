[givm](../../../reference.md) / [牌桌](../../table.md) / [attachment_entity](../attachment_entity.md) / **is_mutable**

# givm::attachment_entity::is_mutable
...
该访问对象是否允许修改角色附属实体。可写实体为 `true`，只读视图为 `false`。
