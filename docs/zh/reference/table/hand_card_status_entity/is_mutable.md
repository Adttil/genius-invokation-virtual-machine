[givm](../../../reference.md) / [牌桌](../../table.md) / [hand_card_status_entity](../hand_card_status_entity.md) / **is_mutable**

# givm::hand_card_status_entity::is_mutable
...
该访问对象是否允许修改手牌上的状态。可写实体为 `true`，只读视图为 `false`。
