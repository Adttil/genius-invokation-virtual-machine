[givm](../../../reference.md) / [牌桌](../../table.md) / [summon_entity](../summon_entity.md) / **begin**

# givm::summon_entity::begin
...
指向该 [`summon_entity`](../summon_entity.md) 访问对象自身的只读指针。若实体无效，它等于 `end()`。
