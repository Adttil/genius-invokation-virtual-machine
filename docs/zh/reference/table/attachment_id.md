[givm](../../reference.md) / [牌桌](../table.md) / **attachment_id**
...
角色附属实体在一张牌桌中的身份。使用此 ID 可以通过 [`card_table::operator[]`](card_table/operator_subscript.md) 再次取得相应实体。
...
int main()
{
    ...
    const givm::attachment_id id = entity.id();
