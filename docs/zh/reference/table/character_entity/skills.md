[givm](../../../reference.md) / [牌桌](../../table.md) / [character_entity](../character_entity.md) / **skills**

# givm::character_entity::skills
...
产生 [`skill_entity`](../skill_entity.md) 的范围。
...
int main()
{
    ...
    for(const auto item : character.skills())
    {
        std::println("技能计数: {}", item.state().count);
    }
}
```
