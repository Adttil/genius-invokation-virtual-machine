[givm](../../../reference.md) / [牌桌](../../table.md) / [combat_status_entity](../combat_status_entity.md) / **state**

# givm::combat_status_entity::state
...
实体持有的 [`combat_status_state`](../combat_status_state.md) 引用；可写实体返回可写引用，只读视图返回只读引用。
