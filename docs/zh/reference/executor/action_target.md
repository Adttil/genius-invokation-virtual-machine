[givm](../../reference.md) / [执行](../executor.md) / **action_target**
...
当前主动切换通过 [`switch_active_character`](execution_view/action_selection/switch_active_character.md) 接收切换候选索引和支付骰子，不使用本类型。
