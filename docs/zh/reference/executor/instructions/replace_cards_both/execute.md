[givm](../../../../reference.md) / [执行](../../../executor.md) / [指令](../../instructions.md) / [replace_cards_both](../replace_cards_both.md) / **execute**

# givm::replace_cards_both::execute
...
让双方分别选择开局需要替换的手牌。每方提交后即可得到该方的替换结果；双方都提交后结束这项准备。
