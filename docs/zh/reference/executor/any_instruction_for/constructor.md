[givm](../../../reference.md) / [执行](../../executor.md) / [any_instruction_for](../any_instruction_for.md) / **(构造函数)**
...
|  |  |
| --- | --- |
| `TInstruction` | [核心给定集合](../instructions.md)中的具体指令类型，须满足 [`instruction_compatible_with`](../instruction_compatible_with.md) |
