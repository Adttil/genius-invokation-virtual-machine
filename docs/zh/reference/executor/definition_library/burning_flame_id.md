[givm](../../../reference.md) / [执行](../../executor.md) / [definition_library](../definition_library.md) / **burning_flame_id**

# givm::definition_library::burning_flame_id
...
本定义库中的有效 `definition_id<summon_view>`。即使编译时只选择了部分定义，该定义也会保留。
