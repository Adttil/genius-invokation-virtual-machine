[givm](../../reference.md) / [指令](../instructions.md) / **deal_damage**
...
对一个角色造成伤害。它为增伤、减伤和护盾等效果提供响应时机，并在扣除生命后处理伤害所携带的元素附着与胜负判定。
...
| | |
| --- | --- |
| [`damage_calculation`](../events/damage_calculation.md) | 计算伤害 |
| [`damage_effect`](../events/damage_effect.md) | 抵挡伤害 |
| [`after_damage`](../events/after_damage.md) | 伤害后的通知 |
