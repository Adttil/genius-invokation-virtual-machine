[givm](../../reference.md) / [指令](../instructions.md) / **absorb_damage_by_count**
...
| | |
| --- | --- |
| `context_type` | [`damage_effect`](../events/damage_effect.md)，仅能在该事件响应中执行 |
...
| | |
| --- | --- |
| [`damage_effect`](../events/damage_effect.md) | 即将扣除生命的伤害 |
