#ifndef GIVM_TABLE_ENTITIES_COMBAT_STATUS_ENTITY_HPP
#define GIVM_TABLE_ENTITIES_COMBAT_STATUS_ENTITY_HPP
...
namespace givm
{
    ...
    public:
        ...
        constexpr operator combat_status_entity<const detail::table_storage>() const noexcept requires is_mutable
        {
            auto result =
                detail::table_accessor::make_uninitialized<combat_status_entity<const detail::table_storage>>();
        ...
        constexpr combat_status_id id() const
        {
            ...
            return {
                player().id(),
                static_cast<size_t>(storage_.data - storage_.player->combat_status_datas.data())
            };
        }
        ...
        {
            return is_valid() && definition().template can_handle<TEvent, combat_status_view>();
        }
    ...
    private:
        constexpr combat_status_entity(detail::uninitialized_entity_t) noexcept {}
