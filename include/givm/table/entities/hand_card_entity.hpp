#ifndef GIVM_TABLE_ENTITIES_HAND_CARD_ENTITY_HPP
#define GIVM_TABLE_ENTITIES_HAND_CARD_ENTITY_HPP
...
template<class TStorage>
    ...
    public:
        ...
        using storage_type = detail::hand_card_entity_storage<TStorage>;

        constexpr operator hand_card_entity<const detail::table_storage>() const noexcept requires is_mutable
        {
            auto result = detail::table_accessor::make_uninitialized<hand_card_entity<const detail::table_storage>>();
        ...
        {
            GIVM_ASSERT(is_valid());
            using status_entity_type = hand_card_status_entity<TStorage>;
        ...
        ) const requires is_mutable
        {
            ...
            auto result = detail::table_accessor::make_uninitialized<hand_card_status_entity<TStorage>>();
            detail::table_accessor::storage_of(result) = {
                .table = storage_.table,
                .owner = id(),
                .slot = index,
    ...
    private:
        constexpr hand_card_entity(detail::uninitialized_entity_t) noexcept {}
