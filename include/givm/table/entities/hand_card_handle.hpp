#ifndef GIVM_TABLE_ENTITIES_HAND_CARD_HANDLE_HPP
#define GIVM_TABLE_ENTITIES_HAND_CARD_HANDLE_HPP
...
namespace givm::detail
{
    ...
    public:
        ...
        constexpr operator hand_card_handle<const TStorage>() const noexcept requires is_mutable
        {
            auto result = detail::table_accessor::make_uninitialized<hand_card_handle<const TStorage>>();
...
namespace givm
{
    ...
    private:
        constexpr hand_card_view(detail::uninitialized_entity_t tag) noexcept : base_type{ tag } {}
    };
}
