#ifndef GIVM_TABLE_ENTITIES_ATTACHMENT_ENTITY_HPP
#define GIVM_TABLE_ENTITIES_ATTACHMENT_ENTITY_HPP
...
namespace givm
{
    ...
    public:
        ...
        constexpr operator attachment_entity<const detail::table_storage>() const noexcept requires is_mutable
        {
            auto result = detail::table_accessor::make_uninitialized<attachment_entity<const detail::table_storage>>();
        ...
        {
            return is_valid() && definition().template can_handle<TEvent, attachment_view>();
        }
    ...
    private:
        constexpr attachment_entity(detail::uninitialized_entity_t) noexcept {}
