#ifndef GIVM_TABLE_ENTITIES_SKILL_HANDLE_HPP
#define GIVM_TABLE_ENTITIES_SKILL_HANDLE_HPP
...
namespace givm::detail
{
    ...
    public:
        ...
        constexpr operator skill_handle<const TStorage>() const noexcept requires is_mutable
        {
            auto result = detail::table_accessor::make_uninitialized<skill_handle<const TStorage>>();
        ...
        {
            GIVM_ASSERT(storage_.data->definition_and_flags != static_cast<size_t>(-1));
            return detail::table_accessor::make_issued_id<skill_view>(
    ...
    private:
        ...
        constexpr basic_skill_handle(detail::uninitialized_entity_t) noexcept {}
...
namespace givm
{
    class skill_view : private detail::basic_skill_handle<const detail::table_storage>
    {
        friend detail::table_accessor;

        using base_type = detail::basic_skill_handle<const detail::table_storage>;
    ...
    private:
        constexpr skill_view(detail::uninitialized_entity_t tag) noexcept : base_type{ tag } {}
    };
}
