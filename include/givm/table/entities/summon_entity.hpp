#ifndef GIVM_TABLE_ENTITIES_SUMMON_ENTITY_HPP
#define GIVM_TABLE_ENTITIES_SUMMON_ENTITY_HPP
...
namespace givm
{
    ...
    public:
        ...
        constexpr operator summon_entity<const detail::table_storage>() const noexcept requires is_mutable
        {
            auto result = detail::table_accessor::make_uninitialized<summon_entity<const detail::table_storage>>();
        ...
        {
            return is_valid() && definition().template can_handle<TEvent, summon_view>();
        }
    ...
    private:
        constexpr summon_entity(detail::uninitialized_entity_t) noexcept {}
