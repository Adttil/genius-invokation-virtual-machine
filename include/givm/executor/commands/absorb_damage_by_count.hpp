#ifndef GIVM_EXECUTOR_COMMANDS_ABSORB_DAMAGE_BY_COUNT_HPP
#define GIVM_EXECUTOR_COMMANDS_ABSORB_DAMAGE_BY_COUNT_HPP
...
{
    inline execution_state absorb_damage_by_count_execute(
    ...
    {
        writer.write(execute_fn{ &absorb_damage_by_count_execute });
