...
namespace givm::detail
{
    ...
    )
    {
        ...
        auto&& [random_pool, player0_random_count_slot, input] = context.stack().push(
    ...
    {
        auto&& [random_pool, player0_random_count, input] =
            context.stack().top<std::uint32_t[], std::uint32_t, selector>();
        ...
        {
            context.stack().pop<std::uint32_t[], std::uint32_t, selector>();
